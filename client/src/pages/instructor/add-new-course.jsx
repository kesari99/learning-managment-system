...
import CourseSetting from '@/components/instructor-view/courses/add-new-course/course-settings'
...
const AddNewCoursePage = () => {
  ...
  const {courseCurriculumFormData,courseLandingFormData,setCourseLandingFormData,setCourseCurriculumFormData, currentEditedCourseId, 
  ...
  function validateFormData(){
    ...
    for(const item of courseCurriculumFormData){
      ...
      if(item.freePreview){
        hasFreePreview = true  //found atleat one free preview
      }
    }
  ...
  async function handleCreateCourse(){
    ...
    curiculum:courseCurriculumFormData,
    isPublished:true,
  ...
  async function fetchCurrentCourseDetails(){
    ...
    if(response?.success){
      ...
      setCourseCurriculumFormData(response?.data?.curiculum)
    }
  }
